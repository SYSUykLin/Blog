    ...
    <div class="row">
        ...
        <div class="col-md-3">
                ...
                <div class="datas">
                    <ul>
                        <c:forEach var="blogTypeCount" items="${blogTypes }">
                            <li><span><a href="${pageContext.request.contextPath}/index.html?typeid=${blogTypeCount.id}">${blogTypeCount.typename }(${blogTypeCount.blogcount })</a></span>
                            </li>
                        </c:forEach>
                    </ul>
                </div>
            ...
            <div class="data_list">
                ...
                <div class="datas">
                    <ul>
                        <c:forEach var="blogCount" items="${blogdate }">
                            <li><span><a href="${pageContext.request.contextPath}/index.html?releasedateString=${blogCount.releasedateString}">${blogCount.releasedateString }(${blogCount.blogcount })</a></span>
                            </li>
                        </c:forEach>
                    </ul>
                </div>
